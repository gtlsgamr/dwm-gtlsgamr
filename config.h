...
static const char audiomutecommand[] = "pamixer -t; kill -34 $(cat ~/.cache/pidofbar)";
...
{ 0,					XF86XK_AudioMute,								spawn,				SHCMD(audiomutecommand) },	
{ 0,					XF86XK_AudioRaiseVolume,						spawn,				SHCMD(audioraisecommand) },	
{ 0,					XF86XK_AudioLowerVolume,						spawn,				SHCMD(audiolowercommand) },	
{ 0,					XF86XK_MonBrightnessUp,							spawn,				SHCMD(brightupcommand) },	
{ 0,					XF86XK_MonBrightnessDown,						spawn,				SHCMD(brightdowncommand) },	
...
{ MODKEY|ShiftMask,		XK_Print,										spawn,				SHCMD(uplscrnshotcommand) },	
{ 0,					XK_Print,										spawn,				SHCMD(fullscrnshotcommand) },	
{ MODKEY,				XK_Print,										spawn,				SHCMD(cpyscrnshotcommand)},	
