...
static const char col_dark3[] = "#434C5E";
static const char col_dark4[] = "#4C566A";

static const char col_light[] = "#D8DEE9";
static const char col_light2[] = "#E5E9F0";
static const char col_light3[] = "#ECEFF4";
...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_light, col_dark, col_dark2 },
	[SchemeSel]  = { col_light3,col_dark3,  col_nord_blue  },
};
static const unsigned int alphas[][3]      = {
	/*               fg      bg        border     */
	[SchemeNorm] = { borderalpha, borderalpha, OPAQUE},
	[SchemeSel]  = { borderalpha, borderalpha, OPAQUE},
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_dark, "-nf", col_light, "-sb", col_light3, "-sf", col_dark3, NULL };
