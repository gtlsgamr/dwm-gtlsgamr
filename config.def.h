...
static const char *fonts[]          = {  "SF Pro Rounded:size=14:style=Bold","NotoEmoji:size=14:antialias=true:autohint=true"};
static const char dmenufont[]       = "SF Pro Rounded:size=14:style=Bold";
