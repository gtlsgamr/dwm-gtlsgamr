...
static const char *fonts[]          = {  "SF Pro Rounded Medium:size=14","NotoEmoji:size=14:antialias=true:autohint=true","SF Pro Rounded Medium:pixelsize=14:antialias=true:autohint=true"};
static const char dmenufont[]       = "SF Pro Rounded Medium:size=14";
...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray1, col_macos_white,  col_macos_gray },
	[SchemeSel]  = { col_gray1, col_macos_white,  col_macos_gray  },
};
