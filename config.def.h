...
static const char *fonts[]          = {  "SF Pro Rounded:size=14:style=Black","NotoEmoji:size=14:antialias=true:autohint=true"};
static const char dmenufont[]       = "SF Pro Rounded:size=14:style=Black";
...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_macos_gray, col_gray1,  col_macos_gray },
	[SchemeSel]  = { col_macos_white, col_gray1,  col_macos_gray  },
};
