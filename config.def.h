...
static const char *fonts[]          = {  "SF Pro Rounded:size=14","NotoEmoji:size=14:antialias=true:autohint=true","SF Pro Rounded:pixelsize=14:antialias=true:autohint=true"};
